...
import com.xreatlabs.xdiscordultimate.modules.information.InformationModule;
import com.xreatlabs.xdiscordultimate.modules.scheduledannouncer.ScheduledAnnouncerModule;
import com.xreatlabs.xdiscordultimate.modules.autoroles.AutoRolesModule;
import com.xreatlabs.xdiscordultimate.modules.serverstatus.ServerStatusModule;
...
public class ModuleManager {
    ...
    public void loadModules() {
        ...
        registerModule("server-status", new ServerStatusModule(plugin));
        registerModule("auto-roles", new AutoRolesModule(plugin));
        registerModule("scheduled-announcer", new ScheduledAnnouncerModule(plugin));
        registerModule("information", new InformationModule(plugin));
        registerModule("sync", new com.xreatlabs.xdiscordultimate.modules.sync.SyncModule(plugin));
    ...
    private boolean isModuleEnabled(String moduleName) {
        if ("chat-bridge".equals(moduleName)) {
            return true;
        }
        return plugin.getConfigManager().isFeatureEnabled(moduleName);
    }
